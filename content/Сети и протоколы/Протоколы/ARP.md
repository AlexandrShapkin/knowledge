...
- В модели **[[../../Сети и протоколы/Модели/OSI]]:** между уровнями 2 и 3 (канальный ↔ сетевой).
- В модели **[[../../Сети и протоколы/Модели/TCP-IP]]:** относится к **сетевому уровню (Network Layer)**, но выполняет функции для передачи на уровне канала.
