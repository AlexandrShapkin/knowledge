...
tags:
  ...
  - internet-layer
---
**MLD (Multicast Listener Discovery)** — это **вспомогательный протокол сетевого уровня (Layer 3)** модели **[[../../Сети и протоколы/Модели/OSI]]**, предназначенный для **управления членством узлов в multicast-группах в IPv6-сетях**.  
...
В модели **[[../../Сети и протоколы/Модели/TCP-IP]]** MLD входит в **сетевой уровень (Internet Layer)** и реализован как часть **[[ICMP#icmpv6-internet-control-message-protocol-for-ipv6|ICMPv6]]** (Protocol = 58).
