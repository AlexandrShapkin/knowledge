...
tags:
  ...
  - internet-layer
---
**ICMP** — это вспомогательный протокол **сетевого уровня (Layer 3)** модели **[[../../Сети и протоколы/Модели/OSI]]**, предназначенный для **передачи диагностических и служебных сообщений**, связанных с работой IP-сетей.  
Он используется узлами и маршрутизаторами для **обнаружения ошибок**, **управления трафиком** и **тестирования соединения**.
В модели **[[../../Сети и протоколы/Модели/TCP-IP]]** ICMP входит в **сетевой уровень (Internet Layer)**, рядом с IP.  
...
ICMPv6 (Protocol = 58) объединяет функции ICMPv4, [[ARP]] и других служебных протоколов.
Основные типы:
