...
tags:
  ...
  - internet-layer
---
**ICMP** — это вспомогательный протокол **сетевого уровня (Layer 3)** модели **[OSI](../../Сети%20и%20протоколы/Модели/OSI.md)**, предназначенный для **передачи диагностических и служебных сообщений**, связанных с работой IP-сетей.  
Он используется узлами и маршрутизаторами для **обнаружения ошибок**, **управления трафиком** и **тестирования соединения**.
В модели **[TCP-IP](../../Сети%20и%20протоколы/Модели/TCP-IP.md)** ICMP входит в **сетевой уровень (Internet Layer)**, рядом с IP.  
...
---
## Особенности
- ICMP **инкапсулируется в [IP](IP.md)-пакет** (Protocol = 1 для ICMPv4, Protocol = 58 для ICMPv6).
- Не использует [TCP](TCP.md) или [UDP](UDP.md) — работает "поверх" [IP](IP.md).
...
ICMPv6 (Protocol = 58) объединяет функции ICMPv4, [ARP](ARP.md) и других служебных протоколов.
Основные типы:
