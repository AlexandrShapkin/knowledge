...
tags:
  ...
  - internet-layer
---
**IGMP (Internet Group Management Protocol)** — это **вспомогательный протокол сетевого уровня (Layer 3)** модели **[[../../Сети и протоколы/Модели/OSI]]**, предназначенный для **управления членством в IPv4-мультикаст-группах (multicast groups)**.  
...
В модели **[[../../Сети и протоколы/Модели/TCP-IP]]** IGMP входит в **сетевой уровень (Internet Layer)** наряду с [[IP]] и [[ICMP]].
...
- **Работает только с IPv4.** Для IPv6 используется **[[MLD|Multicast Listener Discovery]] (ICMPv6)**.
