...
tags:
  ...
  - systemd/зависимости
---
 **Зависимости systemd** определяют порядок запуска, условия работы и взаимосвязи между [[unit-файлы|юнитами]]. Они позволяют задавать, какие сервисы должны стартовать раньше/позже, что является обязательным условием для запуска, а также что должно быть остановлено вместе с юнитом.
