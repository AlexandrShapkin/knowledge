...
Синтаксис и особенности реализации структур в конкретных языках рассматриваются в разделе [программирования и сред выполнения](../Программирование%20и%20среды%20выполнения/index.md). Устройство памяти и влияние аппаратных кешей относятся к разделу [вычислительных систем](../Вычислительные%20системы/index.md). Индексы, планы запросов и структуры хранения баз данных рассматриваются в разделе [данных и хранилищ](../Данные%20и%20хранилища/index.md). Организация модулей и архитектура приложений относятся к разделу [проектирования программного обеспечения](../Проектирование%20программного%20обеспечения/index.md).