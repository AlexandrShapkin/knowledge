...
- В модели **[OSI](../Модели/OSI.md):** между уровнями 2 и 3 (канальный ↔ сетевой).
- В модели **[TCP-IP](../Модели/TCP-IP.md):** относится к **сетевому уровню (Network Layer)**, но выполняет функции для передачи на уровне канала.
