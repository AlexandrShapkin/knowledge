...
tags:
  ...
  - internet-layer
---
**MLD (Multicast Listener Discovery)** — это **вспомогательный протокол сетевого уровня (Layer 3)** модели **[OSI](../Модели/OSI.md)**, предназначенный для **управления членством узлов в multicast-группах в IPv6-сетях**.  
...
В модели **[TCP-IP](../Модели/TCP-IP.md)** MLD входит в **сетевой уровень (Internet Layer)** и реализован как часть **[ICMPv6](ICMP.md#icmpv6-internet-control-message-protocol-for-ipv6)** (Protocol = 58).
