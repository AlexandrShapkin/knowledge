...
tags:
  ...
  - internet-layer
---
**ICMP** — это вспомогательный протокол **сетевого уровня (Layer 3)** модели **[OSI](../Модели/OSI.md)**, предназначенный для **передачи диагностических и служебных сообщений**, связанных с работой IP-сетей.  
Он используется узлами и маршрутизаторами для **обнаружения ошибок**, **управления трафиком** и **тестирования соединения**.
В модели **[TCP-IP](../Модели/TCP-IP.md)** ICMP входит в **сетевой уровень (Internet Layer)**, рядом с IP.  
