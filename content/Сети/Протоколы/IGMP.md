...
tags:
  ...
  - internet-layer
---
**IGMP (Internet Group Management Protocol)** — это **вспомогательный протокол сетевого уровня (Layer 3)** модели **[OSI](../Модели/OSI.md)**, предназначенный для **управления членством в IPv4-мультикаст-группах (multicast groups)**.  
...
В модели **[TCP-IP](../Модели/TCP-IP.md)** IGMP входит в **сетевой уровень (Internet Layer)** наряду с [IP](IP.md) и [ICMP](ICMP.md).
