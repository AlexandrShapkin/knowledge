...
tags:
  ...
  - internet-layer
---
**IGMP (Internet Group Management Protocol)** — это **вспомогательный протокол сетевого уровня (Layer 3)** модели **[[OSI|OSI]]**, предназначенный для **управления членством в IPv4-мультикаст-группах (multicast groups)**.  
...
В модели **[[TCP-IP|TCP-IP]]** IGMP входит в **сетевой уровень (Internet Layer)** наряду с [[IP|IP]] и [[ICMP|ICMP]].
